...
.DATA
	...
	BALL_POS_X DW 100 ; COORDINATES OF THE TOP 
	BALL_POS_Y DW 100 ; LEFT CORNER OF THE BALL
	BALL_SIZE DW 4 ; HEIGHT AND WIDTH OF THE BALL
	BALL_I_SPEED DB 5 ; INITIAL SPEED OF THE BALL
	BALL_JUMP_SPEED DB 1 ; HORIZONTAL SPEED OF THE BALL "IF ONE OF A/a, D/d KEYS WERE PRESSED".
	...
	COLOR DB 00H ; WHITE: 0FH, BLACK: 00H, GREEN: 0AH, BLUE: 0BH
...
.CODE
	...
	MOVE_BALL PROC NEAR
		...
		ENTER_KEY_PRESSED:
			ADD CX, BALL_JUMP_SPEED
			MOV BALL_I_SPEED, CX
			MOV VECTOR_INDEX, 0
			CMP FIRST_PRESS_COUNTER, 10
			JE READ_AND_MOVE_UP
	...
	GEN_RANDOM_BARRIER_HEIGHT PROC NEAR
		MOV RANDOM_RANGE, 4
		CALL GEN_RANDOM_WITH_RANGE
		ADD DX, 1
		MOV RANDOM_BARRIER_HEIGHT_NUMBER, DX
		RET
	GEN_RANDOM_BARRIER_HEIGHT ENDP


	GEN_RANDOM_WITH_RANGE PROC NEAR
		CALL GEN_RANDOM
		MOV  AX, RANDOM_NUMBER
		XOR  DX, DX
		MOV  CX, RANDOM_RANGE    
		DIV  CX      
		RET ; RETURNS DX = RANDOM NUMBER FROM 0 TO RANDOM RANGE
