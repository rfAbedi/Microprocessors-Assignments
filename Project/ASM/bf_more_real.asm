...
.DATA
	...
	FPS_CONTROLLER DB 0 ; USED IN MAIN TO CONTROLL FPS, MAIN IS EXCUTED IN EVERY 0.01 S SO THE FRAME RATE IS 100 FPS
	...
	BALL_JUMP_ACC DW 100 ; ACCELARATION OF BIRD LIFTING FORCE
	BALL_JUMP_FORCE_DURATION DW 1 ; N SECONDS
