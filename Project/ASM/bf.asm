...
.CODE
	...
	TRANSMIT_STATE PROC NEAR
		...
		MOV AL, E3H ; BAUD RATE 9600, PARITY 0, STOP 1, WORD BITS LENGTH 8
		INT 14H
		...
		MOV AL, 'O'
		MOV AH, 01H ; TRANSMIT CHARACTER for GAME OVER
		INT 14H
		RET

		GAME_NOT_OVER_FLAG:
		MOV AL, 'P'
		MOV AH, 01H ; TRANSMIT CHARACTER for PLAY
		INT 14H
		RET
	TRANSMIT_STATE ENDP
